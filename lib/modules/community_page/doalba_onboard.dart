...
import 'package:jmsmart_project/modules/community_page/doalba_modify.dart';
...
import 'package:jmsmart_project/modules/http_api/doalba_api.dart';
...
class CommentData{
  ...
  CommentData(this.applycommentId, this.applyId, this.userId, this.comment, this.createdAt);
  ...
  factory CommentData.fromJson(dynamic json){
    ...
    return CommentData(json['applycommentId'] as int, json['applyId'] as int, json['userId'] as int,
        json['comment'] as String, createdDateString as String);
  }

  @override
  String toString() {
    return '{${this.applycommentId}, ${this.applyId}, ${this.userId}, ${this.comment}, ${this.createdAt}}';
  }
}
...
class Data {
  ...
  Data(this.applyId, this.userId, this.title, this.content, this.createdAt);

  factory Data.fromJson(dynamic json){
    DateTime createdDate = DateTime.parse(json['createdAt']);
    String createdDateString = DateFormat("yyyy/MM/dd").format(createdDate);
    return Data(json['applyId'] as int, json['userId'] as int, json['title'] as String,
        json['content'] as String, createdDateString as String);
  }

  @override
  String toString() {
    return '{${this.applyId}, ${this.userId}, ${this.title}, ${this.content}, ${this.createdAt}}';
  }
}
...
class DoAlbaOnboardPage extends StatefulWidget {
  ...
  @override
  _DoAlbaOnboardPageState createState() => _DoAlbaOnboardPageState();
}
...
class _DoAlbaOnboardPageState extends State<DoAlbaOnboardPage> {
  ...
  void _fetchPosts(String applyId) async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String token = (prefs.getString('accessToken') ?? "");
    final response = await http.get(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => DoAlbaModifyPage()));
                                },
                            ...
                            child: Visibility(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  doalba_writing_delete(_datas2[data3 - 1].applyId.toString());
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return GestureDetector(
                                  ...
                                  child: Text(data.title.toString(),
                                      style: TextStyle(
                                          fontFamily: 'GmarketSans', fontSize: 16, color: Colors.black))
                              );
                            }),
                      ),
                      SizedBox(height: size.height * 0.01),
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return GestureDetector(
                                      ...
                                      child: Text(data.content.toString(),
                                          style: TextStyle(
                                              fontFamily: 'GmarketSans', fontSize: 12, color: Colors.black))
                                  );
                                }),
                          ),
                          Container(
                              ...
                              onPressed: () {
                                ...
                                setState(() {
                                  if (commentvalidate == 0) {
                                    ...
                                    doalba_comment_post(commentinfo[0], data2);
                                        ...
                                        children: [
                                                        ...
                                                        builder: (ctx) => AlertDialog(
                                                          ...
                                                          actions: <Widget>[
                                                            ...
                                                            TextButton(
                                                                ...
                                                                onPressed: () {
                                                                  community_comment_delete(data.applycommentId.toString());
                                                                }
                                                            ),
                                                          ],
                                                        ),
                                          ...
                                          SizedBox(
                                            ...
                                            child: IconButton(
                                              ...
                                              onPressed: () {
                                                updatecommentLike(data.applycommentId.toString());
                                                setState(() {
